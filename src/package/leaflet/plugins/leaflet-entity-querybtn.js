...
L.Control.QueryBtn2 = L.Control.extend({
  options: {
    position: 'topleft',
    btnText: ' <i class="el-icon-edit-outline" title="选择服务类型" ></i>'
  },
...
L.control.querybtn2 = (options) => {
  return new L.Control.QueryBtn2(options);
}
